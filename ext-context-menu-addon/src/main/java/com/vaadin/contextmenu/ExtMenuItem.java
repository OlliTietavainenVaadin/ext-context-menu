...
public interface ExtMenuItem extends Serializable {
    ...
    ExtMenuItem addSeparatorBefore(ExtMenuItem itemToAddBefore);
     ...
     */
    ExtMenuItem addItem(String caption, Command command);
     ...
     */
    ExtMenuItem addItem(String caption, String url);
     ...
     */
    ExtMenuItem addItem(String caption, Resource icon, Command command)
            throws IllegalStateException;
     ...
     *             If the item is checkable and thus cannot have children.
     */
    ExtMenuItem addItemBefore(String caption, Resource icon, Command command,
            ExtMenuItem itemToAddBefore) throws IllegalStateException;
     ...
     * top-level menu bar.
     * 
     * @return The containing {@link ExtMenuItem} , or null if there is none
     */
     ...
     */
    void removeChild(ExtMenuItem item);
